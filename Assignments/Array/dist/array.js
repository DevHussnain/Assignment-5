...
// 13TH METHOD
const doubleNum = arr1.map((num) => num * 2);
console.log(doubleNum);
const changeToString = arr1.map((num) => num.toString());
console.log(changeToString);
// 14TH METHOD
let eveNum = arr1.filter((num) => num % 2 === 0);
console.log(eveNum);
let graterThanTree = arr1.filter((num) => num > 3);
